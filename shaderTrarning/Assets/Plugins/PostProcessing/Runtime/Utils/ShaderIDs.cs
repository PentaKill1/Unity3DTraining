namespace UnityEngine.Rendering.PostProcessing
{
    ...
    static class ShaderIDs
    {
        ...
        internal static readonly int FogColor1 = Shader.PropertyToID("_FogColor");
        internal static readonly int FogStart = Shader.PropertyToID("FogStart");
        ...
        internal static readonly int OutArea = Shader.PropertyToID("_OutArea");
        internal static readonly int InArea = Shader.PropertyToID("_InArea");
